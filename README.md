...
15/08/2026: Finalização da base do site(implementação da pesquisa e estilização parcial das seções).

16/08/2026: Conclusão parcial do projeto com todas as seções completamente estilizadas.

16/08/2026: Conclusão total do projeto com a implementação do modo de visualização escuro e de retoques finais na parte da estilização.
